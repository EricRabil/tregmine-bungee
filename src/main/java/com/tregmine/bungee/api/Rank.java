...
public enum Rank {
	UNVERIFIED(ChatColor.WHITE), TOURIST(ChatColor.WHITE), SETTLER(ChatColor.GREEN), RESIDENT(
			ChatColor.DARK_GREEN), DONATOR(ChatColor.GOLD), GUARDIAN(ChatColor.BLUE), CODER(
					ChatColor.DARK_PURPLE), BUILDER(
							ChatColor.YELLOW), JUNIOR_ADMIN(ChatColor.RED), SENIOR_ADMIN(ChatColor.DARK_RED);
